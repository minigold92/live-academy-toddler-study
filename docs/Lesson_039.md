...
> 📺 **원본 영상**: [[ 기초영어회화 ] 기분을 풀어주다 / 말이 잘못 나오다 / 마음을 상하게 하다](https://www.youtube.com/watch?v=BmKpL--OVXg)
> ⏱ 7분 56초 · 👁 199K회
...
> 4. **`I didn't mean to hurt her feelings`** — 그녀에게 상처를 주려던 게 아니었어 (didn't mean to)
> 5. `hurt someone's feelings` = 누군가에게 마음의 상처를 주다
...
> **I was just trying to cheer her up. But the words came out wrong. It was an honest mistake. I didn't mean to hurt her feelings.**
> (나는 그냥 그녀 기분 풀어주려고 했던 거야. 근데 말이 잘못 나왔어. 정말 모르고 한 실수였어. 그녀에게 상처 주려던 게 아니었어.)
...
1. **I was just trying to** — `just`의 `t`를 묵음 처리 후 바로 이어서. "아이 워즈 저스ˈ 트라잉 투".
2. **trying to** — `to`의 `t`가 `n`처럼 연음. "트라잉 너" 정도의 느낌.
3. **cheer her up** — `cheer`와 `her`의 `er` 발음이 겹침. `her`의 `h`를 뭉개면서 "치어r업".
4. **came out wrong** — `out`의 `t`를 끊고 이어. "케임 아웃ˈ 롱".
5. **it was an honest** — `it`의 `t` 약하게 끊고, `an honest`를 부드럽게 이어. "이t 워즈 언 아니스ˈ".
6. **I didn't mean to** — `didn't`를 후루룩 흘리듯 발음. "아이 디른ˈ 민 투".
7. **hurt her feelings** — `hurt`의 `t` 후 `her`의 `h` 묵음 처리. "허rˈ어 필링즈".

---

## 📝 파생 연습 (5문제)

1. **영작**: "나는 그냥 걔 기분을 좀 풀어주려고 했었어." (him)
2. **변환**: "말이 제대로 나오지 않았어." (didn't come out right)
3. **영작**: "그를 화나게 하려던 게 아니었어." (`upset`)
4. **조합**: 오늘의 4문장을 그대로 써 보기 (암기 연습).
5. **응용**: "그녀에게 상처를 주고 싶지 않았어." (didn't want to)

<details>
<summary>정답 보기</summary>

1. `I was just trying to cheer him up.`
2. `My words didn't come out right.`
3. `I didn't mean to upset him.`
4. `I was just trying to cheer her up. But the words came out wrong. It was an honest mistake. I didn't mean to hurt her feelings.`
5. `I didn't want to hurt her feelings.`
</details>
